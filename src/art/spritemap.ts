...
const ATTACH: Record<string, AttachSpriteKey> = {
  ...
  // content 'att-*' namespace — the vocabulary actually used in src/data/attachments.ts
  ...
  'att-comp': 'barrel-brake',
  'att-barrel-heavy': 'barrel-heavy',
  'att-barrel-long': 'barrel-heavy',
  'att-barrel-short': 'barrel-brake',
  'att-choke': 'barrel-brake',

  'att-grip-vert': 'under-grip',
  'att-grip-angled': 'under-grip',
  'att-bipod': 'under-bipod',
  'att-laser': 'under-laser',
  'att-lamp': 'under-laser',
  'att-bayonet': 'under-bayonet',

  'att-mag-ext': 'mag-extended',
  'att-mag-drum': 'mag-drum',
  'att-mag-taped': 'mag-quick',
  'att-shellholder': 'mag-quick',

  'att-stock-fold': 'stock-folding',
  'att-stock-target': 'stock-precision',
  'att-stock-pad': 'stock-fixed',
  'att-stock-cheek': 'stock-precision',
  'att-stock-tape': 'stock-folding',

  'att-trigger': 'internal-trigger',
  'att-bumpkit': 'internal-bumpfire',
  'att-springs': 'internal-spring',
  'att-chamber': 'internal-spring',
  'att-gasblock': 'internal-spring',
  'att-shim': 'internal-spring',
  'att-bore': 'internal-trigger',
};
